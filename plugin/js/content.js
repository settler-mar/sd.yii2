...
var iconFavoriteClose = '<svg width="15" height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792"><path d="M1664 596q0-81-21.5-143t-55-98.5T1506 295t-94-31-98-8-112 25.5-110.5 64-86.5 72-60 61.5q-18 22-49 22t-49-22q-24-28-60-61.5t-86.5-72-110.5-64T478 256t-98 8-94 31-81.5 59.5-55 98.5T128 596q0 168 187 355l581 560 580-559q188-188 188-356zm128 0q0 221-229 450l-623 600q-18 18-44 18t-44-18l-624-602q-10-8-27.5-26T145 952.5 77 855 23.5 734 0 596q0-220 127-344t351-124q62 0 126.5 21.5t120 58T820 276t76 68q36-36 76-68t95.5-68.5 120-58T1314 128q224 0 351 124t127 344z"/></svg>';
var iconFavoriteOpen = '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 50 50"><path d="M25 48.1q-.7 0-1.1-.6L7.8 29.4q-.3-.2-.7-.7-.5-.6-1.4-2-1-1.4-1.8-2.9t-1.4-3.7Q1.9 18 1.9 16q0-6.6 3.3-10.4 3.3-3.7 9-3.7 1.6 0 3.3.7 1.7.6 3.1 1.7Q22 5.4 23 6.4q1.1.9 2 2 .9-1.1 2-2 1-1 2.4-2.1t3.1-1.7q1.7-.7 3.3-.7 5.7 0 9 3.7 3.3 3.8 3.3 10.4 0 6.6-5.9 13.5l-16.1 18q-.4.6-1.1.6z"/></svg>';

var storePluginHtml = '<div class="secretdiscounter-extension__header">'+
    '<a href="{{siteUrl}}" class="secretdiscounter-extension__logo" target="_blank">'+logoImage+logoImageWhite+'</a>'+
    '<div class="secretdiscounter-extension__button_close"><div class="secretdiscounter-extension__button_icon">&times;</div></div>'+
    '</div>'+
...
Storage.clear = function(callback) {
    ...
    function closeClick() {
        ...
        document.cookie = 'secretdiscounter-extension-window=hidden';
    }
...
window.onload = function() {
    ...
    if (getCookie('secretdiscounter-extension-window') !== 'hidden') {
        findShop();
    }
