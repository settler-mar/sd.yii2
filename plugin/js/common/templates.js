...
var storeHtml = '<div class="secretdiscounter-extension__shop"><img class="secretdiscounter-extension__shop-logo" src="{{storeLogo}}"/>'+
    ...
    '<span class="secretdiscounter-extension__buttons-title {{buttonsClass}}">{{buttonMessage}}</span>'+
    '</div>';
//любой сайт, не из шопов
var storeHtmlEmpty = '<div class="secretdiscounter-extension__buttons">'+
    '<div class="secretdiscounter-extension__buttons-empty">{{emptyCashbackMessage}}</div>'+
    '<a class="secretdiscounter-extension__buttons-link sd_button" href="'+siteUrl+'/stores" target="_blank">{{allStores}}</a>'+
    '</div>';
...
var favoriteHTML ='<div class="secretdiscounter-extension__shop"><img class="secretdiscounter-extension__shop-logo" src="{{storeLogo}}"/>'+
    '<div class="secretdiscounter-extension__shop-text">{{cashback}}{{storeText}}</div>'+
    '<a class="sd_button {{buttonClass}}" data-store="{{storeRoute}}" href="{{storeUrl}}">{{buttonText}}</a>'+
    '</div>';
...
var storePluginHtml = '<div class="secretdiscounter-extension__header">'+
    ...
    '<a class="secretdiscounter-extension__link sd_button" href="{{storeUrl}}" data-store="{{storeRoute}}" target="_blank">{{buttonText}}</a>'+
    '<span class="secretdiscounter-extension__buttons-message">{{buttonMessage}}</span>'+
    '</div>';
...
var couponHtml = '<div class="secretdiscounter-extension__coupon">'+
  ...
  '<div class="secretdiscounter-extension__coupon-item secretdiscounter-extension__coupon-date">{{dateExpireMessage}}: <span>{{couponDateEnd}}</span></div>'+
  '<div class="secretdiscounter-extension__coupon-item secretdiscounter-extension__coupon-promocode">' +
    '{{promocodeText}}: <span class="secretdiscounter-extension__coupon-promocode-text copy-content">{{couponPromocode}}</span></div>'+
  '</div>'+
  '<div class="secretdiscounter-extension__coupon-right">'+
  '<a class="secretdiscounter-extension__coupon-promocode-link sd_button" data-store="{{storeRoute}}" href="{{couponUseLink}}">{{usePromocode}}</a>'+
  '</div>'+
  '</div>';