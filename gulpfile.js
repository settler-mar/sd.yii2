...
gulp.task('jsadmin', compileJs([
    ...
    paths.source.js+'/original/admin/elfinder.js',
    paths.source.js+'/original/admin/editor.js',
    paths.source.js+'/external/twig.min.js',
    paths.source.js+'/original/new/select2.js',
    paths.source.js+'/original/admin/products.js',
    paths.source.js+'/original/admin/categories_tree.js'
