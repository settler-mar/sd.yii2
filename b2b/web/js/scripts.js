...
$('.ajax-action').click(function(e) {
  ...
  if (ids.length > 0) {
    ...
    if (content) {
      ...
      data['id'] = ids;
      console.log(content, $(content).find('input,select'), data)
    } else {
      data = {
          status: status,
          param: param,
