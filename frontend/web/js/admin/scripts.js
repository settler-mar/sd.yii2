...
function ajaxForm(els) {
  ...
  function onFail(){
    ...
    wrap=data.wrap;
    wrap.removeClass('loading');
    wrap.html('Упс... Возникла непредвиденная ошибка.  Часто это происходит в случае, если вы несколько раз подряд неверно ввели свои учетные данные. Но возможны и другие причины. В любом случае не расстраивайтесь и просто обратитесь к нашему оператору службы поддержки.  Спасибо.');
    ajaxForm(wrap);
