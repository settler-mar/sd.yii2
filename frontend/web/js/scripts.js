...
var sdTooltip = function () {
    ...
    function setPositon(elem, position){
        ...
        var norevert = $(elem).data('norevert');//задана позиция внутри элемента
        switch(position) {
            case 'top':
