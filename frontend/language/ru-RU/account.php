...
return [
    ...
    'dobro_autopay_text' => 'Нажимая кнопку "Установить автоплатёж", я соглашаюсь с тем, что <strong>весь</strong> мой накопленный кэшбэк в конце<br> каждого календарного месяца будет направляться данному благотворительному фонду.',
    ...
    'user_loyalty_reg_status' => 'Вам будет присвоен пожизненный премиум аккаунт после регистрации.',
];