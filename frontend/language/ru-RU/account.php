...
return [
    ...
    'user_loyalty_reg_status_{title}_forever' => 'Вам будет присвоен пожизненный {title} статус после <a href="{href}" class="registration modals_open">регистрации</a>',
    'user_loyalty_reg_status_{title}_for_{days}_' => 'Вам будет присвоен статус {title} сроком на {days} дней после <a href="{href}" class="registration modals_open">регистрации</a>',
