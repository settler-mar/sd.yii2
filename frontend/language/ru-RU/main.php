...
return [
    ...
    'sort_by_price' => 'Сначала дорогие',
    'sort_by_price_mobile' => 'Сначала дорогие',
    ...
    'sort_by_name_mobile' => 'Названию',
    'sort_by_time' => 'Дате добавления',
    'sort_by_time_mobile' => 'Дате добавления',
    'sort_by_discount' => 'По размеру скидки',
    'sort_by_discount_mobile' => 'По размеру скидки',
    'sort_by_price_asc' => 'Сначала дешёвые',
    'sort_by_price_asc_mobile' => 'Сначала дешёвые',
    ...
    'store_instruction' => 'Инструкция по получению кэшбэка',
    'read_all_tarifs_terms' => 'Все тарифы и условия',
    ...
    'popular_stores_from_{category}_cashback' => 'Популярные магазины из раздела &laquo;{category}&raquo; с&nbsp;кэшбэком',
    'popular_stores_from_{category}_cashback_offline' => 'Популярные магазины из раздела &laquo;{category}&raquo; с&nbsp;кэшбэком',
    ...
    'store_points_{store}_in_{country}_{sity}' => 'Адреса торговых точек {store} в {country}, {city}',
    ...
    'calc_cashback_{store}_cashback <span class="shop-calc-cashback_content-result-value calc-result_value">0</span> cur' => 'Ваш кэшбэк для магазина <span class="shop-calc-cashback_content-result-store">{store}</span> составит до <span class="shop-calc-cashback_content-result-value calc-result_value">0</span> {currency}',
    ...
    'reviews_about_coupon' => 'Отзывы покупателей',
    'reviews_about_coupon_empty' => 'Отзывов пока нет',
    ...
    'review_add_form_coupon_{coupon}' => 'Отзыв о купоне {coupon}',
    ...
    'review_edit' => 'Редактирование отзыва',
    ...
    'review_exists_you_can_only_<br>_<a class="modals_open" href="{edit}">edit</a>_previesly_added_review' => 'Вы уже оставили отзыв о сайте.<br> Теперь вы можете только <a href="{edit}" class="modals_open">изменить</a> или <a href="{edit}" class="modals_open">дополнить</a><br>ранее оставленный <a href="{edit}" class="modals_open">отзыв</a>',
    ...
    'wrong_promocode' => 'Такого промокода не существует. Проверьте правильность ввода.',
    ...
    'we_apologize' => 'Приносим свои извинения',
    'plugin_for_browser_is_under_construction' => 'Плагин для браузера { key } находится в разработке',
    'next_page' => 'Следующая',
    'previous_page' => 'Предыдущая',
    'first_page' => 'Первая',
    'last_page' => 'Последняя',
    'order_by_buy_count' => 'Популярности',
    'order_by_buy_count_mobile' => 'Популярности',
    'order_by_last_price' => 'Цене',
    'order_by_last_price_mobile' => 'Цене',
    'order_by_last_buy' => 'Дате покупки',
    'order_by_last_buy_mobile' => 'Дате',
    ...
    "bay_loyalty_title" => "Покупка {status}-статуса",
    "loyalty_status_bay_description" => "Данный статус позволит вам получать повышенный на {bonus}% кэшбэк (по сравнению с базовой ставкой).",
    "loyalty_status_bay_no_bonus" => "Ваш текущий статус лояльности выше, чем тот, который вы собираетесь приобрести.",
    "loyalty_status_bay_no_price" => "Статус не продается.",
    "loyalty_status_bay_no_money" => "Не хватает денег на покупку статуса. Стоимость — {price} {currency} на 1 месяц. <br>Доступно средств — {balance} {currency}.",
    "loyalty_status_bay_yes_content" => "Стоимость - {price} {currency} на 1 месяц, деньги спишутся с вашего баланса.",
    'loyalty_status_bay_thanks' => 'Спасибо за покупку. Ваш {status}-статус подключен и будет действовать ровно месяц.',
    ...
    'INR' => 'INR',
    'TRY' => 'TRY',
    'action_description_not'=>'<a target="_blank" rel="noopener noreferrer nofollow" href="{url}">Как повысить кэшбэк?</a>',
    ...
    'action_description_loyality'=>'Ваш кэшбэк увеличен на {bonus}% в соответствии с нашей <a target="_blank" rel="noopener noreferrer nofollow" href="{url}">программой лояльности</a>',
    'action_description_loyality_reg'=>'Ваш кэшбэк увеличен на {bonus}% в связи с <a target="_blank" rel="noopener noreferrer nofollow" href="{url}">бонусом за регистрацию</a>',
    ...
    'affiliate_system_text' => 'Приглашайте друзей и получайте 15% от их кэшбэка. Ваш друг при этом не получит меньше – мы выплачиваем из собственных средств.',
    'shtrih_code' => 'ВАШ ШТРИХКОД',
    'filter-city-tittle' => 'Выберите город',
    'filter-city-option-select' => 'Выберите город',
];