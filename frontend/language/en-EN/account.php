...
return [
    ...
    'user_balance' => 'Баланс',
    'user_balance_current <span>{value}</span>' => 'Текущий баланс:  <span>{value} <span class="fa fa-rub"></span></span>',
    'user_balance <span>{value}</span>' => 'Баланс:  <span>{value} <span class="fa fa-rub"></span></span>',
    'user_balance_in_waiting <span>{value}</span>' => 'В ожидании:  <span>{value} <span class="fa fa-rub"></span></span>',
    'user_balance_charity <span>{value}</span>' => 'Пожертвовано:  <span>{value} <span class="fa fa-rub"></span></span>',
