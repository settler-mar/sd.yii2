...
return [
    ...
    'notification_twig_template'=>[
        ...
        'notification_text_ref_0'=>'User <b>ID{{user_id}}</b> has made a purchase at <b>{{shop_name}}</b> (order No.{{order_id}}). Expected bonus is <b>({{amount}} {{currency}})</b>.',//Affiliate Bonus',

        'notification_title_ref_1'=>'Affiliate bonus declined',
        'notification_text_ref_1'=>'Unfortunately, a bonus of <b>({{amount}} {{currency}})</b> for order No.{{order_id}} of user <b>ID{{user_id}}</b> at <b>{{shop_name}}</b> has been declined.',//Affiliate Bonus',

        'notification_title_ref_2'=>'Affiliate bonus assigned',
        'notification_text_ref_2'=>'You have been assigned a bonus of <b>({{amount}} {{currency}})</b> for order No.{{order_id}} of user <b>ID{{user_id}}</b> at <b>{{shop_name}}</b>.',//Affiliate Bonus',

        'notification_title_manual_1'=>'Sign-Up Bonus',
        'notification_text_manual_1'=>'You have been assigned <b>({{amount}} {{currency}})</b> of bonus for signing up on our website.',

        'notification_title_manual_2'=>'Bonus from SecretDiscounter',
        'notification_text_manual_2'=>'You have been assigned a bonus of <b>({{amount}} {{currency}})</b> from the administration of SecretDiscounter.',
