      ...
      <table cellspacing="0" cellpadding="0" width="600" style="border-collapse: collapse !important;">
        ...
        <tr>
          <td style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #777777; border-collapse: collapse; line-height: 21px; width: 100% !important; padding: 10px 60px 0px;">
            ...
            <br>
            <br>
            <span style="color: #4d4d4d; font-weight: bold; text-decoration: none;">Login: <?=$user->email;?></span><br>
            <span style="color: #4d4d4d; font-weight: bold;">Password: <?=$user->new_password;?></span>
            <br>
            <br>
            <br>
            Также всем новым пользователям мы дарим premium-аккаунт на 10 дней, позволяющий получать на 30% больше кэшбэка.
            <br>
            Подробнее о нашей накопительной системе лояльности <a href="https://secretdiscounter.ru/en/loyalty">читайте здесь</a>
          </td>
        </tr>
        <tr>
          <td style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #777777; border-collapse: collapse; line-height: 21px; padding: 30px 0;">
            <div><!--[if mso]>
              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://secretdiscounter.ru/en/account" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#0f181a" fillcolor="#f7c714">
                <w:anchorlock/>
                <center style="color:#0f181a;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">Мой аккаунт</center>
              </v:roundrect>
              <![endif]--><a href="https://secretdiscounter.ru/en/account"
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%"
                              ...
                              <tr>
                                <td
                                  ...
                                  <a href="https://secretdiscounter.ru/en/stores/<?=$store['route'];?>"
                                ...
                                <td
                                  ...
                                  <div><!--[if mso]>
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                 ...
                                                 href="https://secretdiscounter.ru/en/stores/<?=$store['route'];?>"
                                    ...
                                    <![endif]--><a href="https://secretdiscounter.ru/en/stores/<?=$store['route'];?>"
