...
<?php $this->beginBody() ?>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="min-width: 600px; border-collapse: collapse !important;" width="100%">
        <tr>
            <td align="left" valign="top" width="100%" style="background:repeat-x url(https://secretdiscounter.com/images/email/bg_top.jpg) #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #777777; text-align: center; border-collapse: collapse; line-height: 21px;">
                <center>
                    <img style="border: none; height: 0px !important; line-height: 1px !important; font-size: 1px !important;" src="https://secretdiscounter.com/images/email/transparent.png" >
                    <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" background="https://secretdiscounter.com/images/email/bg_top.jpg" style="background-color:transparent; border-collapse: collapse !important;">
                        <tr>
                            <td width="100%" height="80" valign="top" style="text-align: center; vertical-align:middle; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #777777; border-collapse: collapse; line-height: 21px;">
                                ...
                                <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="mso-width-percent:1000;height:80px; v-text-anchor:middle;">
                                    <v:fill type="tile" src="https://secretdiscounter.com/images/email/bg_top.jpg" color="#ffffff" />
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse !important;">
                                        <tr>
                                            <td style="vertical-align: middle; text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #4d4d4d; border-collapse: collapse; line-height: 21px; padding-left: 10px;">
                                                <a href="https://secretdiscounter.com/" target="_blank" style="#4d4d4d; text-decoration: none !important;"><img src="https://secretdiscounter.com/images/templates/secretdiscounter-logo-d.png" style="border: 0px;width:170px;" alt="logo"></a>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                    ...
                    <table cellspacing="0" cellpadding="0" width="600" style="border-collapse: collapse !important;">
                        <tr>
                            <td style="text-align: right;">
                                <a href="https://secretdiscounter.com/" target="_blank" style="#4d4d4d; text-decoration: none !important;"><img src="https://secretdiscounter.com/images/email/logo_mini.png" style="border: 0px;width:70px;margin-right: 10px;" alt="logo"></a>
                            </td>
