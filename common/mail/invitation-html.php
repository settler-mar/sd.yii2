      ...
      <table cellspacing="0" cellpadding="0" width="600" style="border-collapse: collapse !important;">
        <tr>
          <td style="text-align: center; font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; font-size: 32px; font-weight: 700; line-height: normal; padding: 35px 0 0; color: #4d4d4d;">
            Вас приглашают на SecretDiscounter
          </td>
        </tr>
        <tr>
          <td style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #777777; border-collapse: collapse; line-height: 21px; width: 100% !important; padding: 10px 60px 0px;">
            Здравствуйте! Пользователь <strong><?=$user->name;?> (<?=$user->email;?>)</strong> приглашает Вас присоединиться к кэшбэк-сервису SecretDiscounter, где вы будете возвращать часть потраченных на покупки денег — кэшбэк. Помимо этого, у вас появится доступ к тысячам различных купонов и промокодов. Переходите по ссылке ниже и начните экономить прямо сейчас!
          </td>
        </tr>
        <tr>
          <td style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #777777; border-collapse: collapse; line-height: 21px; padding: 30px 0;">
            <div><!--[if mso]>
              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?=$reflink;?>" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#0f181a" fillcolor="#fff200">
                <w:anchorlock/>
