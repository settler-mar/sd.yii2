...
//    ]);
    ...
    if (file_exists($path)) {
        $y_verification = file_exists($path.'/y-verification.txt') ? file_get_contents($path.'/y-verification.txt') : false;
        $y_metrica = file_exists($path.'/y-metrica.txt') ? file_get_contents($path.'/y-metrica.txt') : false;
        $g_analytics = file_exists($path.'/g-analytics.txt') ? file_get_contents($path.'/g-analytics.txt') : false;
    }
    //ddd($y_verification, $y_metrica, $g_analytics);
