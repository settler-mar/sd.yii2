...
$dict = [
    ...
    'twig_template'=>[
      ...
      'notification_text_ref_0'=>'Пользователь <b>ID{{ref_id}}</b> в <b>{{shop_name}}</b> совершил покупку (заказ №{{order_id}}). Ожидаемое вознаграждение <b>({{amount}} руб.)</b>.',//Бонус за реферала',

      'notification_title_ref_1'=>'Вознаграждение партнера отклонено',
      'notification_text_ref_1'=>'К сожалению, комиссионное вознаграждение <b>({{amount}} руб.)</b> за заказ №{{order_id}} пользователя <b>ID{{ref_id}}</b> в <b>{{shop_name}}</b> отклонено.',//Бонус за реферала',

      'notification_title_ref_2'=>'Начислено вознаграждение партнера',
      'notification_text_ref_2'=>'Вам было начислено комиссионное вознаграждение <b>({{amount}} руб.)</b> за заказ №{{order_id}} пользователя <b>ID{{ref_id}}</b> в <b>{{shop_name}}</b>.',//Бонус за реферала',
