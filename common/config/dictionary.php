...
$dict = [
    ...
    'twig_template' => [
        ...
        'notification_text_manual_4' => 'Ваш премиум-аккаунт отключен по истечении 10 дней после регистрации. Подробнее о нашей накопительной системе лояльности читайте <a href="https://secretdiscounter.com/loyalty">здесь</a>.',
    ],
    'twig_list_name' => [
        0 => "Автоматически",
