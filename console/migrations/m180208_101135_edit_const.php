...
<p>Процент возвращаемого кэшбэка указан на&nbsp;&laquo;квадратике&raquo; каждого магазина,&nbsp;а также в верхней части карточки магазина.</p>
</div>
</div>
...
<li>Попадаете на подробную страницу магазина, ознакамливаетесь со всеми условиями и тарифами и нажимате &laquo;Перейти к покупкам&raquo;.<strong><em><br /></em></strong></li>
<li>Осуществляется переход в магазин, в котором вы выбираете нужный товар и оформляете заказ как обычно.</li>
