...
/**
 * Class m180605_083712_updateMetaPagesMailRu
 */
class m180605_083712_updateMetaPagesMailRu extends Migration
{
    /**
     * {@inheritdoc}
     */
...
<div class=\"on_promo\"><a class=\"registration btn\" href=\"#registration\">Зарегистрировать Platinum-аккаунт</a></div>
</div>
{% endif %}</div>" WHERE `page` = "mail-ru-level-1"';
        $this->execute($sql);
...
{% endif %}</div>" WHERE `page` = "mail-ru-level-3"';
    ...
    {
        echo "m180605_083712_updateMetaPagesMailRu cannot be reverted.\n";
