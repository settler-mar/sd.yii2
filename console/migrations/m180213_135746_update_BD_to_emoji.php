...
/**
 * Class m180213_135746_update_BD_to_emoji
 */
class m180213_135746_update_BD_to_emoji extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
      ...
      $this->execute('ALTER TABLE `cw_metadata` CHANGE `description` `description` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL;');
      $this->execute('ALTER TABLE `cw_metadata` CHANGE `content` `content` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL;');
      ...
      $constant->title = "Таблица сравнения конкурентов";
    ...
    {
        echo "m180213_135746_update_BD_to_emoji cannot be reverted.\n";
