...
class m180402_172946_UpdataMailRuLevelContentTable extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $meta->content = '<div class="mail-ru">
            ...
            <h2 class="title-no-line white">Пожизненный серебряный аккаунт в кэшбэк-сервисе<br />SecretDiscounter.ru</h2>
            <p class="clearfix"><img style="float: right;" src="https://secretdiscounter.ru/img/bonus.mail.ru/secretdiscounter-mailbonus-20%203.png" alt="secretdiscounter-mailbonus-20 3.png (28 KB)" width="209" height="106" /><strong>Кэшбэк-сервис SecretDiscounter возвращает деньги с покупок в 1300+ магазинов</strong>. <strong>В онлайне и оффлайне</strong>. И как вы, наверное, знаете, в нашем кэшбэк-сервисе существуют <strong><a href="https://secretdiscounter.ru/loyalty" target="_blank" rel="noopener">четыре уровня лояльности</a></strong>: максимальный из них, уровень Platinum, <strong>увеличивает вашу ставку кэшбэка на 30%</strong>. Это означает, что если тот же магазин Adidas возвращает 5% кешбэка, то с платиновым аккаунтом &ndash; уже 6,5%. Получить такой аккаунт непросто: вы должны накопить не менее 10 тыс. рублей кэшбэка в нашей системе. Но есть и приятная новость: при регистрации прямо сейчас мы <strong>подарим вам такой аккаунт на 10 дней бесплатно!</strong></p>
    ...
    public function safeDown()
    {
        ...
        $meta = Meta::find()->where(['page'=> 'mail-ru-level-1'])->one();
        $meta->content = '<img src="https://secretdiscounter.ru/img/bonus.mail.ru/secretdiscounter-mailbonus.jpg" alt="secretdiscounter-mailbonus.jpg (266 KB)" width="1170" height="524" />
            <h2 class="title-no-line">Пожизненный серебряный аккаунт в кэшбэк-сервисе SecretDiscounter.ru</h2>
            <p class="clearfix"><img style="float: right;" src="https://secretdiscounter.ru/img/bonus.mail.ru/secretdiscounter-mailbonus-20%203.png" alt="secretdiscounter-mailbonus-20 3.png (28 KB)" width="209" height="106" /><strong>Кэшбэк-сервис SecretDiscounter возвращает деньги с покупок в 1300+ магазинов</strong>. <strong>В онлайне и оффлайне</strong>. И как вы, наверное, знаете, в нашем кэшбэк-сервисе существуют <strong><a href="https://secretdiscounter.ru/loyalty" target="_blank" rel="noopener">четыре уровня лояльности</a></strong>: максимальный из них, уровень Platinum, <strong>увеличивает вашу ставку кэшбэка на 30%</strong>. Это означает, что если тот же магазин Adidas возвращает 5% кешбэка, то с платиновым аккаунтом &ndash; уже 6,5%. Получить такой аккаунт непросто: вы должны накопить не менее 10 тыс. рублей кэшбэка в нашей системе. Но есть и приятная новость: при регистрации прямо сейчас мы <strong>подарим вам такой аккаунт на 10 дней бесплатно!</strong></p>
