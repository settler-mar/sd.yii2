...
$('#store-recommendation-link-checkbox').click(function(){
  if (!this.checked) {
    notification.notifi({
      'title': 'Внимание!',
      'type':'err',
      'message': 'Для того, чтобы ваш кэшбэк отследился корректно, настоятельно рекомендуем ознакомиться с <b><a href="/recommendations">нашими правилами</a></b> и следовать им при совершении покупок.'
    });
  }
});
